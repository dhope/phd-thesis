...
\committee{%
  \chair{Dr B. Crespi}{Professor}
  \member{Dr. R.C. Ydenberg}{Senior Supervisor\\Professor}
  \member{Dr. D.B. Lank}{Supervisor\\Adjunct Professor}
  \member{Dr. M.C. Drever}{Supervisor\\Migratory Bird Biologist\\Environment and Climate Change Canada}
  \member{Dr. D.C. Bradley}{Supervisor\\British Columbia Director\\Bird Studies Canada}
  \member{Dr L.K. M'Gonigle}{Internal Examiner\\Assistant Professor}
  \member{Dr B.A. Nolet}{External Examiner\\Professor, Faculty of Science\\University of Amsterdam}
}
