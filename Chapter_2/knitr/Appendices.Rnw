...
<<mc-counts, fig.cap='The average seasonal pattern of daily counts at large (black) and small (red) sites. Individual Monte Carlo simulations are shown in grey shading. Model simulations are shown with and without prior knowledge', fig.scap="">>=
