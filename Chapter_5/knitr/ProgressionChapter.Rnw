...
than 2000 km from the breeding grounds ($w_i$ = 0.63). This parameter divided sites into
...
not include the north/south interaction term ($w_i$ = 0.25). In the top model, only the
...
(Table 5.4; $w_i$ =0.58). Though the second and third supported
